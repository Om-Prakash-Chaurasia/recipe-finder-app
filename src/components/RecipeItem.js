                        ...
                        <div className='recipe-details-sec flex flex-col gap-5 row-start-1 lg:row-auto'>
                            ...
                            <div className='buttons flex flex-col gap-5 items-start lg:flex-row'>
                                <button
                                    ...
                                    className={`bg-gradient-to-br p-3 px-8 rounded-lg text-sm uppercase font-bold tracking-wider mt-2 inline-block shadow-md hover:shadow-lg duration-300 outline-none text-center ${itemSavedStatus
